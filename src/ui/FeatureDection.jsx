...
export function FeaturesSectionDemo() {
  ...
  return (
    <div className="relative z-20 py-10 lg:py-40 max-w-7xl mx-auto bg-black rounded-4xl">
      <div className="px-8">
        <h4
    ...
    <div className="relative flex py-8 px-2 gap-10 h-full">
      <div
        ...
        <div className="flex flex-1 w-full h-full flex-col space-y-2  ">
          {/* TODO */}
          <img
            src="https://res.cloudinary.com/dqudvximt/image/upload/v1753859321/Screenshot_2025-07-30_123755_l8s26o.png"
            alt="header"
            width={800}
            height={800}
